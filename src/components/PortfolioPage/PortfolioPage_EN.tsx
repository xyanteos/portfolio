        ...
        <>
            ...
            <div className='project'>
                <h2 className="centered">
                    Backend microservice for measurement sensors
                </h2>
                ...
                <p>
                    The project (AirQ) premise was to create a dockerized solution designed to gather air quality information provided to us by our clients sensors, ensuring a proper data flow
            ...
            <div className="project">
                <h2 className="centered">Projekt CRUD w stacku MERN</h2>
                <div className="imagesContainer">
            ...
            <div className="project">
                <h1 className="centered">Projekt Wykorzystania NASA API</h1>
                <br />
                <div className="imagesContainer">
            ...
            <div className="project">
                <h2 className='centered'>Projekt Wykorzystania Youtube API</h2>
                <br />
                <div className="imagesContainer">
